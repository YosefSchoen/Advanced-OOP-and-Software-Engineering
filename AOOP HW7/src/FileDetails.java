...
//  Do not add any functionality to the Files.FileDetails hierarchy apart from the visitor pattern implementation.
public abstract class FileDetails {
    ...
    public  abstract void accept(FilesVisitor filesVisitor);
